...
const Hero = () => {
  ...
  return (
    <section id="accueil" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-yellow-50 dark:from-black dark:to-gray-900 overflow-hidden transition-colors duration-300 pt-20">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-gray-800 to-yellow-600 dark:from-white dark:to-yellow-400 animate-pulse">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mt-16">
            <button 
              ...
              className="group bg-gradient-to-r from-black to-gray-800 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:shadow-2xl hover:scale-110 transition-all duration-300 flex items-center space-x-3 border-2 border-yellow-400"
            >
              <span>🚀</span>
            ...
            <button 
              ...
              className="group bg-gradient-to-r from-green-500 to-green-600 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:bg-green-600 hover:shadow-2xl hover:scale-110 transition-all duration-300 flex items-center space-x-3"
            >
              <span>💬</span>
